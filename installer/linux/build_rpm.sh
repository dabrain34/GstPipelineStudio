...
if [ -f "${DESKTOP_FILE}" ]; then
    test_ok sed 's/@icon@/org.freedesktop.dabrain34.GstPipelineStudio/' "${DESKTOP_FILE}" > \
        "${BUILDROOT}/usr/share/applications/org.freedesktop.dabrain34.GstPipelineStudio.desktop"
else
...
%{_datadir}/applications/org.freedesktop.dabrain34.GstPipelineStudio.desktop
%{_datadir}/icons/hicolor/scalable/apps/org.freedesktop.dabrain34.GstPipelineStudio.svg
%{_datadir}/icons/hicolor/symbolic/apps/org.freedesktop.dabrain34.GstPipelineStudio-symbolic.svg
