...
Copy-Item -Path C:\gst-install\bin\gst-pipeline-studio.exe -Destination c:\gst-install-clean\bin\
Copy-Item -Path C:\gst-install\bin\gst-*-1.0.exe -Destination c:\gst-install-clean\bin\
